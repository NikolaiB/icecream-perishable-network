...
describe('Ice Cream Perishable Shipping Network', () => {
    ...
    before(() => {
        ...
        .then(() => {
            ...
            return businessNetworkConnection.connect('defaultProfile', 'icecream-perishable-network', 'admin', 'Xurw3yU9zI0l');
        })
        .then(() => {
